...
use Optti\Framework\Traits\API_Response;
...
class API {
	 ...
	 * @var string
	 */
	protected $api_url = 'https://alttext-ai-backend.onrender.com';
	...
	protected function __construct() {
		$this->api_url = apply_filters( 'optti_api_url', $this->api_url );
	...
	protected function get_auth_headers( $args = [] ) {
		...
		if ( class_exists( '\Optti\Framework\License' ) ) {
